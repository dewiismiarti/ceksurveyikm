...
def load_data():
    DATABASE_SHEET_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTnkNV11ueBoj7bbOuodSFoVKBt8HVJdvpFlKbJnh1yOZgPsr5YFnqlUrNhNKBtQ5Cu3kRK7-XA2lc3/pub?gid=68142080&single=true&output=csv"
    RESPONSE_SHEET_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTnkNV11ueBoj7bbOuodSFoVKBt8HVJdvpFlKbJnh1yOZgPsr5YFnqlUrNhNKBtQ5Cu3kRK7-XA2lc3/pub?gid=1258026261&single=true&output=csv"
    ...
    response_data['Nama Mata Kuliah '] = response_data['Nama Mata Kuliah '].str.strip().str.upper()
    ...
    if student_id:
        ...
        if not student_courses.empty:
            ...
            student_courses['IKM Sudah Terisi'] = student_courses['Matakuliah'].apply(
                lambda x: 'Sudah' if x in response_data_filtered['Nama Mata Kuliah '].values else 'Belum'
            )
...
st.write("---")
st.info("Jika Anda sudah mengisi survei namun belum terekap, kemungkinan Anda salah menginputkan NIM pada formulir survei.")
